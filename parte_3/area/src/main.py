...
x_max = (58880 + x_offset)/unit_dist # Longitud máxima en x
y_max = (42300 + y_offset)/unit_dist # Longitud máxima en y
# Un grid separado uniformemente
xedges, xstep = np.linspace(0, x_max, num=50, retstep=True)
yedges, ystep = np.linspace(0, y_max, num=50, retstep=True)
...
img_sav_file_celdas = "../img/densidad_celdas_area"
img_sav_file_nets = "../img/densidad_nets_area"
img_sav_file_pines = "../img/densidad_pines_area"
